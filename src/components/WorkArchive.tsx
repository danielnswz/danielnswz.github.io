        ...
        <div className="grid divide-y divide-light-border dark:divide-ink-border">
          {workArchive.map((item) => {
            ...
            return (
              ...
              >
                <p className="font-mono text-sm text-ink/50 dark:text-light/50 pt-0.5 sm:text-right">
                  {item.year}
                </p>
                <div className="grid gap-1.5 min-w-0">
                  <div className="flex items-center gap-2 text-xs font-mono">
                    ...
                    <span className="text-ink/50 dark:text-light/50">{kindLabel[item.kind]}</span>
                  </div>
                ...
                {externalUrl && (
                  <span className="hidden sm:flex items-center justify-self-end pt-0.5 text-ink/30 transition-colors group-hover:text-accent dark:text-light/30 dark:group-hover:text-accent">
