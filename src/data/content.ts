...
export const experience: ExperienceItem[] = [
  {
    ...
    bullets: [
      ...
      "Leveraged Micro-frontends (Module Federation), GraphQL, Go services and RabbitMQ to optimize system modularity, UI performance, and asynchronous communication.",
      "Applied methodologies with agentic coding tools (AI) to define technical requirements, accelerate system prototyping, and refactor backend services.",
      "Contributed to different agentic coding workflows, including CI/CD pipelines, automated code reviews, and code generation for repetitive tasks, significantly improving development efficiency and code quality.",
      "Acted as Subject Matter Expert (SME) across core microservices, providing technical guidance, clear documentation, and cross-team knowledge sharing.",
    ],
    tags: [
      "Preact",
      "React",
  ...
  },
  {
    ...
    company: "Zonngo",
    companyHandle: "zonngo",
    type: "Full-time",
    period: "2017 — 2018",
    location: "Remote",
    bullets: [
      "Designed and delivered a secure Node.js backend, REST APIs, and OAuth server components for a retail price monitoring platform.",
      "Built foundations across REST and OAuth server design.",
    ],
    tags: ["Node.js", "MongoDB", "Mongoose ODM", "MySQL", "REST", "OAuth"],
  },
  {
    role: "Full Stack Web Developer (Project-based)",
    company: "Agentes Informaticos, C.A.",
    companyHandle: "agentes",
    type: "Full-time",
    period: "2015 — 2016",
    location: "Trabajo Remoto",
    bullets: [
      "Engineered dynamic inventory web software applications using PHP Laravel and AngularJS.",
      "Built and maintained backend and frontend features across the stack.",
    ],
    tags: [
      "JavaScript",
      "PHP",
  ...
  },
  {
    ...
    company: "Seguros Caroni, S.A.",
    companyHandle: "caroni",
    type: "Internship",
    period: "2016",
    location: "Puerto Ordaz",
    bullets: [
      "Engineered health insurance management databases and supporting internal software workflows.",
      "Collaborated on data modeling and implementation for business-critical insurance operations.",
    ],
    tags: ["MySQL", "Database Design", "SQL", "Internal Tools"],
  },
];
