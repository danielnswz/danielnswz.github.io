...
export const previouslyAt: CompanyMention[] = [
  ...
  { handle: 'softvision', name: 'Cognizant Softvision', url: 'https://www.cognizant.com/softvision' },
  { handle: 'fortesza', name: 'Fortesza' },
  { handle: 'zonngo', name: 'Zonngo' },
]

export const roleConstellation = ['Full-Stack Engineer', 'Distributed Systems Architect', 'Mobile Cross-Platform', 'Technical Lead'] as const
...
export const experience: ExperienceItem[] = [
  {
    ...
    tags: ['React', 'Redux', 'NX', 'GraphQL', 'RabbitMQ', 'Node.js', 'Module Federation'],
  },
  {
    role: 'Full Stack Developer',
    company: 'SweatWorks',
    ...
    tags: ['React', 'Redux', 'Redux-Thunk', 'Node.js', 'AWS Lambda', 'Serverless', 'Sequelize', 'Cognito', 'SQS', 'S3', 'SES', 'Redis'],
  },
  {
    ...
    tags: ['React Native', 'Redux', 'Redux-Saga', 'Re-select', 'Native SDK Bridges', 'Dependency Injection'],
  },
  {
...
export const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    status: 'Shipped',
    stack: ['React Native', 'Redux', 'Redux-Saga', 'Re-select', 'Native SDK Bridges'],
    description:
  ...
  },
  {
    ...
    highlights: ['Node.js + REST API design', 'OAuth client & server', 'Retail data ingestion'],
  },
]
...
export const skills: SkillGroup[] = [
  {
    ...
    skills: ['JavaScript', 'TypeScript', 'React', 'Redux', 'Angular 6+', 'Node.js', 'GraphQL', 'HTML', 'CSS', 'PHP'],
  },
  {
    title: 'Distributed & Architecture',
    skills: ['Micro-frontends', 'Module Federation', 'RabbitMQ', 'GraphQL Federation', 'REST APIs', 'OAuth'],
  },
  {
    title: 'Mobile',
    skills: ['React Native', 'Redux-Saga', 'Re-select', 'Native SDK Bridges', 'Dependency Injection'],
  },
  {
    title: 'Cloud & Serverless',
    skills: ['AWS Lambda', 'Serverless', 'AWS Cognito', 'SQS', 'S3', 'SES', 'Redis', 'CI/CD'],
  },
  {
    title: 'Databases & ORM',
  ...
  },
  {
    ...
    skills: ['NX', 'Monorepo', 'Git', 'Scrum', 'Code Review', 'Mentoring', 'Technical Leadership'],
  },
]
...
export const workArchive: WorkArchiveItem[] = [
  {
    ...
    blurb: 'Module Federation across a large React/Redux monorepo, with GraphQL gateways and RabbitMQ-backed workflows.',
    url: 'https://autofi.com',
    kind: 'live',
  },
  {
    ...
    blurb: 'Personal portfolio — Vite + React + TypeScript + Tailwind. Open source on GitHub.',
  ...
  },
  {
    ...
    blurb: 'High-traffic consumer APIs coordinating inventory, financing, and retail surfaces behind a GraphQL federation.',
    kind: 'internal',
  },
  {
    year: '2021',
    ...
    blurb: 'AWS Lambdas + Cognito auth + SQS queuing + Redis rate limiter for high-throughput traffic spikes.',
    kind: 'internal',
  },
  {
    year: '2020',
    ...
    blurb: 'Cross-platform sales app with custom native bridges to POS terminals, printers, and mounting stands.',
    kind: 'internal',
  },
  {
    year: '2019',
    ...
    blurb: 'Multi-user investor & company admin panels. Angular 6+ migration lead, reactive forms + metrics charts.',
    kind: 'internal',
  },
  {
    year: '2018',
    ...
    blurb: 'Local SME discovery app — connecting barbershops, tailors, and services to digital clients.',
    kind: 'live',
  },
  {
    year: '2017',
    ...
    blurb: 'Secure Node.js backend, REST APIs, and OAuth server components for a retail price monitoring platform.',
    kind: 'internal',
  },
  {
    year: '2012',
    ...
    blurb: 'Five-year Computer Engineering degree. Data structures, distributed systems, software architecture, DB design.',
    kind: 'internal',
  },
]
